...
*/
    ...
    event: function(ev, msg){
		...
		case 'btn_play':   //button play
			this.showInter();
			break;
		case 'btn_continue': //event on button sound
			this.checkInterval() && this.showInter();
			break;
		case 'btn_restart': //event on button help
			//...
			break;
		case 'btn_levels': //event on Dealer Bust - You Won
			//this.checkInterval() && this.showInter();
			break;
		case 'btn_level': //event on Dealer Win - You Lost
			//this.checkInterval() && this.showInter();
			break;
		case 'btn_info': //event on button replay, when bank=0
			//this.showInter();
			break;
		case 'test':
    ...
    //=========================
	start: function(){
		setTimeout(function(){gradle.event_ext('hide_splash');phaserInit();}, 1000);
    },
	pause: function(){
